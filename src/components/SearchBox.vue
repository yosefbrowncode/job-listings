...
<template>
  <Transition>
    <div v-show="showBox.count > 0" class="static -mt-20 sm:my-auto       sm:absolute  sm:top-28  inset-x-0 container mx-auto pb-4   h-fit  w-11/12 sm:w-9/12 rounded-md bg-300 flex flex-row shadow-xl bg-my-white">
